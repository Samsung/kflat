...
#define KFLAT_RECIPE(SYM, FUNC) \
    { .owner = THIS_MODULE, .symbol = SYM, .handler = FUNC }
#define KFLAT_RECIPE_EX(SYM, FUNC, PRE_FUNC) \
    { .owner = THIS_MODULE, .symbol = SYM, .handler = FUNC, .pre_handler = PRE_FUNC }
