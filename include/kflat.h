...
#define DBGS(M, ...)					do { if (KFLAT_ACCESSOR->FLCTRL.debug_flag&1) flat_infos(M, ##__VA_ARGS__); } while(0)
#define DBGM1(name,a1)					do { if (KFLAT_ACCESSOR->FLCTRL.debug_flag&1) flat_infos(#name "(" #a1 ")\n"); } while(0)
...
#define DBGM2(name,a1,a2)				do { if (KFLAT_ACCESSOR->FLCTRL.debug_flag&1) flat_infos(#name "(" #a1 "," #a2 ")\n"); } while(0)
...
#define DBGTP(name,T,P)					do { if (KFLAT_ACCESSOR->FLCTRL.debug_flag&1) flat_infos(#name "(" #T "," #P "[%llx])\n", (uint64_t)P); } while(0)
#define DBGTNP(name,T,N,P)				do { if (KFLAT_ACCESSOR->FLCTRL.debug_flag&1) flat_infos(#name "(" #T "," #N "," #P "[%llx])\n", (uint64_t)P); } while(0)
#define DBGM3(name,a1,a2,a3)			do { if (KFLAT_ACCESSOR->FLCTRL.debug_flag&1) flat_infos(#name "(" #a1 "," #a2 "," #a3 ")\n"); } while(0)
#define DBGM4(name,a1,a2,a3,a4)			do { if (KFLAT_ACCESSOR->FLCTRL.debug_flag&1) flat_infos(#name "(" #a1 "," #a2 "," #a3 "," #a4 ")\n"); } while(0)
#define DBGM5(name,a1,a2,a3,a4,a5)		do { if (KFLAT_ACCESSOR->FLCTRL.debug_flag&1) flat_infos(#name "(" #a1 "," #a2 "," #a3 "," #a4 "," #a5 ")\n"); } while(0)
#define DBGM6(name,a1,a2,a3,a4,a5, a6)	do { if (KFLAT_ACCESSOR->FLCTRL.debug_flag&1) flat_infos(#name "(" #a1 "," #a2 "," #a3 "," #a4 "," #a5 "," #a6 ")\n"); } while(0)
